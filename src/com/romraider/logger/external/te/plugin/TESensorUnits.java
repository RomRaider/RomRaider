...
public enum TESensorUnits {
    ...
    private TESensorUnits(int value) {
        this.value = value;
    }
    ...
    public static TESensorUnits valueOf(int value) {
    	TESensorUnits[] types = values();
        for (TESensorUnits type : types) {
            if (type.v() == value) return type;
        }
        throw new IllegalArgumentException("Unknown Tech Edge Sensor Units: " + value);
    }
}
