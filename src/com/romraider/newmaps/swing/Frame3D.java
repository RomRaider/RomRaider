...
import com.romraider.newmaps.ecudata.DataCell;
import com.romraider.newmaps.ecudata.Table3DData;
...
public class Frame3D extends RomRaiderFrame {
    private static final Logger LOGGER = Logger.getLogger(Frame3D.class);
    Table3DData table;
    RomRaiderJTable xAxisTable;
    RomRaiderJTable yAxisTable;
    RomRaiderJTable jTable;
    ...
    public Frame3D(Table3DData table) {
        ...
        jTable = new RomRaiderJTable(metadata.getSizeX(), metadata.getSizeY());
