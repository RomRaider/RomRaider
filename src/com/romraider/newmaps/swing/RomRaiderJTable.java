package com.romraider.newmaps.swing;
...
public class RomRaiderJTable extends JTable {
    ...
    public RomRaiderJTable(int columns, int rows) {
        super(rows, columns);
    ...
    public void toClipBoard(int cut) {
        ...
        for (Iterator iter = clipBoardHS.iterator(); iter.hasNext();) {
            ...
            if (cut == RomRaiderJTable.CUT) {
                setSelectionBackground(this.cutSelectionColour);
                setAction(RomRaiderJTable.CUT);
            } else if (cut == RomRaiderJTable.COPY) {
                setSelectionBackground(this.copySelectionColour);
                setAction(RomRaiderJTable.COPY);
            }
            repaint();
        }
    ...
    class MouseMotionH implements MouseMotionListener {
        private RomRaiderJTable myJTable = null;

        public MouseMotionH(RomRaiderJTable myJTable) {
            super();
    ...
    class EventKeyHandler extends KeyAdapter {
        ...
        public EventKeyHandler(RomRaiderJTable myJTable) {
            super();
            this.myJTable = myJTable;
        }
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if ((e.isControlDown() && e.getKeyCode() == 67)) {
                myJTable.toClipBoard(RomRaiderJTable.COPY);
                return;
            } else
                /*Paste*/
                if ((e.isControlDown() && e.getKeyCode() == 86)) {
                    ...
                    if (cell != null) {
                        ...
                        if (myJTable.getAction() == RomRaiderJTable.CUT)
                    ...
                    if ((e.isControlDown() && e.getKeyCode() == 88)) {
                        myJTable.toClipBoard(RomRaiderJTable.CUT);
                        return;
                    } else if (e.getModifiers() == (InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK | InputEvent.BUTTON1_MASK)) {
                        //myJTable.changeSelection(5,5,false, true);

                    } else if (e.getModifiers() == (InputEvent.SHIFT_MASK | InputEvent.BUTTON1_MASK)) {
                        cellSelection.clear();
                        //currentSelection.clear();
                    ...
                    } else if (e.getModifiers() == (InputEvent.CTRL_MASK | InputEvent.BUTTON1_MASK)) {
                        //currentSelection.clear();
