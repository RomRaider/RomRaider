...
package com.romraider.newmaps.definition;

import static com.romraider.newmaps.definition.AttributeParser.parseEndian;
import static com.romraider.newmaps.definition.AttributeParser.parseStorageType;
import static com.romraider.newmaps.definition.AttributeParser.parseUnitSystem;
import com.romraider.newmaps.definition.index.Index;
import com.romraider.newmaps.definition.index.IndexItem;
import com.romraider.newmaps.ecumetadata.AxisMetadata;
import com.romraider.newmaps.ecumetadata.Category;
import com.romraider.newmaps.ecumetadata.ParameterMetadata;
import com.romraider.newmaps.ecumetadata.RomMetadata;
import com.romraider.newmaps.ecumetadata.Scale;
import com.romraider.newmaps.ecumetadata.SourceDefAxisMetadata;
import com.romraider.newmaps.ecumetadata.SwitchGroupMetadata;
import com.romraider.newmaps.ecumetadata.SwitchMetadata;
import com.romraider.newmaps.ecumetadata.Table2DMetadata;
import com.romraider.newmaps.ecumetadata.Table3DMetadata;
import com.romraider.newmaps.ecumetadata.TableMetadata;
import com.romraider.newmaps.ecumetadata.Unit;
import com.romraider.newmaps.xml.SaxParserFactory;
import static com.romraider.util.HexUtil.hexToInt;
import com.romraider.util.NamedSet;
...
public class RomDefinitionHandler extends DefaultHandler {
    private static final Logger LOGGER = Logger.getLogger(RomDefinitionHandler.class);
    ...
    public void startElement(String uri, String localName, String qName, Attributes attr) {
        ...
        if (TAG_ROM.equalsIgnoreCase(qName)) {
            ...
            // Set all other attributes
            LOGGER.info(attr.getValue(ATTR_USER_LEVEL));
            if (attr.getIndex(ATTR_USER_LEVEL) > -1) {
    ...
    public void endElement(String uri, String localName, String qName) {
        ...
        if (TAG_SCALE.equalsIgnoreCase(qName)) {
            ...
            if (table == null && switchGroup != null) {
                switchGroup.setDescription(charBuffer.toString());
            } else {
