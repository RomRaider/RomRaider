...
public class Table3D extends Table {
    ...
    public void verticalInterpolate() {
        ...
        if (coords[3] - coords[1] > 1) {
            ...
            x1 = axisData[coords[1]].getRealValue();
            x2 = axisData[coords[3]].getRealValue();
            for (i = coords[0]; i <= coords[2]; ++i) {
                y1 = tableData[i][coords[1]].getRealValue();
                y2 = tableData[i][coords[3]].getRealValue();
    ...
    public void horizontalInterpolate() {
        ...
        if (coords[2] - coords[0] > 1) {
            ...
            x2 = axisData[coords[2]].getRealValue();
